...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pycronserver-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15502&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pycronserver-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pycronserver` can be installed with:

```
conda install pycronserver
```

It is possible to list all of the versions of `pycronserver` available on your platform with:
